...
inline void gcode_M104() {
  ...
  void print_heaterstates() {
      ...
      SERIAL_PROTOCOL_F(thermalManager.degHotend(target_extruder), 10);
      SERIAL_PROTOCOLPGM(" /");
      SERIAL_PROTOCOL_F(thermalManager.degTargetHotend(target_extruder), 10);
    ...
    #if HAS_TEMP_BED
      SERIAL_PROTOCOLPGM(" B:");
      SERIAL_PROTOCOL_F(thermalManager.degBed(), 10);
      SERIAL_PROTOCOLPGM(" /");
      SERIAL_PROTOCOL_F(thermalManager.degTargetBed(), 10);
      #if ENABLED(SHOW_TEMP_ADC_VALUES)
      ...
      HOTEND_LOOP() {
        ...
        SERIAL_PROTOCOLCHAR(':');
        SERIAL_PROTOCOL_F(thermalManager.degHotend(e), 10);
        SERIAL_PROTOCOLPGM(" /");
        SERIAL_PROTOCOL_F(thermalManager.degTargetHotend(e), 10);
        #if ENABLED(SHOW_TEMP_ADC_VALUES)
